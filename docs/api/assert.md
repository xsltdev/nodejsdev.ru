---
description: Модуль assert предоставляет простой набор так называемых assertion тестов или «тестов утверждения», которые могут быть использованы в тестировании инвариантов
---
