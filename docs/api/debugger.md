---
title: Отладчик
description: Утилита отладки командной строки Node.js для пошагового выполнения и инспекции кода через node inspect и Chrome DevTools
---

# Отладчик

[:octicons-tag-24: latest](https://nodejs.org/docs/latest-v25.x/api/debugger.html)
...
Отладчик автоматически останавливается на первой исполняемой строке. Чтобы вместо этого выполнение шло до первой точки останова (заданной оператором [`debugger`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Statements/debugger)), установите переменную окружения `NODE_INSPECT_RESUME_ON_START` в `1`.
