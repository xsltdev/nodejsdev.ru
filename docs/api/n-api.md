...
Node-API — это C API, обеспечивающий стабильность ABI между версиями Node.js и разными уровнями компиляторов. Благодаря этой гарантии аддоны можно писать и на других языках поверх Node-API. Список языков и движков см. в [language and engine bindings][].
