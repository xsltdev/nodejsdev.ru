...
* [Разрешения на уровне процесса](#process-based-permissions) управляют доступом процесса Node.js к ресурсам.
  ...
  Эта возможность не защищает от злонамеренного кода. Согласно [политике безопасности][политике безопасности] Node.js, движок доверяет любому коду, который ему предлагают выполнить.
...
Если вы обнаружили потенциальную уязвимость безопасности, ознакомьтесь с нашей [политикой безопасности][политике безопасности].
...
API доступно за флагом [`--permission`](cli.md#--permission): при его включении доступ ко всем перечисленным разрешениям ограничивается.
...
[политике безопасности]: https://github.com/nodejs/node/blob/main/SECURITY.md
