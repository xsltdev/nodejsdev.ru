...
-   `readable` [`<stream.Readable>`](stream.md#streamreadable) | [`<Object>`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Object) Классический Readable или любой объект с методами `read()` и `on()`.
...
-   `writable` [`<stream.Writable>`](stream.md#streamwritable) | [`<Object>`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Object) Классический Writable или любой объект с методами `write()` и `on()`.
-   `options` [`<Object>`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Object)
