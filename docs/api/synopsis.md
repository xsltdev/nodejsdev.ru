...
Дополнительные сведения см. в документе [Параметры командной строки](cli.md#options).

## Пример

Ниже приведён пример [веб-сервера](http.md), написанного на Node.js, который отвечает строкой `'Hello, World!'`:
...
Сначала убедитесь, что Node.js загружен и установлен. Дополнительную информацию по установке см. в разделе [Установка Node.js через пакетный менеджер](https://nodejs.org/en/download/package-manager/).
