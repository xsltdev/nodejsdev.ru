...
Дополнительные сведения см. в документе [Параметры командной строки][Параметры командной строки].

## Пример

Ниже приведён пример [веб-сервера][веб-сервера], написанного на Node.js, который отвечает строкой `'Hello, World!'`:
...
Сначала убедитесь, что Node.js загружен и установлен. Дополнительную информацию по установке см. в разделе [Установка Node.js через пакетный менеджер][Установка Node.js через пакетный менеджер].
