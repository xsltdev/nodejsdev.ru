...
??? note "История"
    ...
    | v18.0.0 | Теперь будет выдано исключение, если файл не может быть записан. |
    | v18.0.0 | Сделайте возвращаемые коды ошибок единообразными на всех платформах. |
...
* `callbacks` [`<Object>`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Object) [Hook Callbacks][Hook Callbacks] для регистрации
...
Подробности — в разделе [Hook Callbacks][Hook Callbacks].
...
* `callback` [`<Function>`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Function) Callback to be invoked before serialization.
* `data` [<any>](https://developer.mozilla.org/docs/Web/JavaScript/Data_structures#Data_types) Optional data that will be passed to the `callback` when it
  gets called.
...
* `callback` [`<Function>`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Function) Callback to be invoked after the snapshot is
  deserialized.
* `data` [<any>](https://developer.mozilla.org/docs/Web/JavaScript/Data_structures#Data_types) Optional data that will be passed to the `callback` when it
  gets called.
...
* `callback` [`<Function>`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Function) Callback to be invoked as the entry point after the
...
* Returns: [`<SyncCPUProfileHandle>`](v8.md)
...
* Returns: [`<SyncHeapProfileHandle>`](v8.md)
