...
## Введение {#modules-ecmascript-modules}
...
## Спецификаторы `импорта` {#import-specifiers}
...
## Утверждения импорта {#import-assertions}
...
## Импорт HTTPS и HTTP {#https-and-http-imports}
...
### Спецификация алгоритма резольвера {#resolver-algorithm-specification}
