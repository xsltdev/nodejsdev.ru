...
<big>Fastify безопасен и быстр, но это не защищает его от злоупотреблений. В этой главе вы узнаете, как реализовать **безопасные конечные точки с проверкой ввода** и сделать их быстрее с помощью процесса сериализации.</big>
...
!!!info "Технические требования"
    ...
    :material-source-repository: Все фрагменты в этой главе находятся на [GitHub](https://github.com/PacktPublishing/Accelerating-Server-Side-Development-with-Fastify/tree/main/Chapter%205).
