...
В этой статье вы познакомитесь с возможностями нового бегуна тестирования и рассмотрите несколько примеров.
...
Теперь, когда вы поняли, что нужно тестировать, перейдем к следующему разделу, где вы создадите свой первый тест с помощью тестового бегуна Node.js.
...
В бегуне тестирования Node.js есть встроенные возможности mocking, которые идеально подходят для тестирования внешних API, стороннего кода или методов. Это гарантирует, что ваши модульные тесты будут стабильными и не будут зависеть от внешних факторов, таких как сетевое подключение или изменения в файловой системе.
...
Эта настройка тестирования обеспечивает надежный способ убедиться, что ваши приложения Fastify работают правильно в контролируемой среде с помощью тестового бегуна Node.

## Заключительные мысли

В этой статье представлено подробное руководство по использованию бегуна тестирования Node.js для создания и выполнения тестов. В ней освещены такие функции, как мокинг, анализ покрытия кода и генерация отчетов, которые необходимы для оценки эффективности тестов.
